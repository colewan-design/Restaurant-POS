        ...
        async handleSubmit(userId) {
            ...
            if (!this.isDuplicate()) {
                try {
                    ...
                    const response = await fetch('/api/hdmf_premiums/create', {
                        method: 'POST',
                        headers: {
                    ...
                    if (response.ok) {
                        ...
                        this.$router.push({ name: 'contributions.hdmf_premiums.index', query: { showSuccessDialog: 'true' } });
                    } else {
                ...
                console.log('HDMF Premium is a duplicate.');
            }
        },

        isDuplicate() {
            return this.existingHdmfPremium.includes(this.hdmf_premium_id);
        },
