        ...
        async handleSubmit(userId) {
            ...
            if (!this.isDuplicate()) {
                try {
                    ...
                    const response = await fetch('/api/gsis_premiums/create', {
                        method: 'POST',
                        headers: {
                    ...
                    if (response.ok) {
                        ...
                        this.$router.push({ name: 'contributions.gsis_premiums.index', query: { showSuccessDialog: 'true' } });
                    } else {
                ...
                console.log('GSIS Premium is a duplicate.');
            }
        },

        isDuplicate() {
            return this.existingGsisPremium.includes(this.gsis_premium_id);
        },
