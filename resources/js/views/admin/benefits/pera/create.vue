        ...
        async handleSubmit(userId) {
            ...
            if (!this.isDuplicate()) {
                try {
                    ...
                    const response = await fetch('/api/pera/create', {
                        method: 'POST',
                        headers: {
                    ...
                    if (response.ok) {
                        ...
                        this.$router.push({ name: 'benefits.pera.index', query: { showSuccessDialog: 'true' } });
                    } else {
                ...
                console.log('pera is a duplicate.');
            }
        },

        isDuplicate() {
            return this.existingPeraData.includes(this.pera_id);
        },
