        ...
        async handleSubmit(userId) {
            ...
            if (!this.isDuplicate()) {
                try {
                    ...
                    const response = await fetch('/api/philam_billings/create', {
                        method: 'POST',
                        headers: {
                    ...
                    if (response.ok) {
                        ...
                        this.$router.push({ name: 'billings.philam_billings.index', query: { showSuccessDialog: 'true' } });
                    } else {
                ...
                console.log('philam is a duplicate.');
            }
        },

        isDuplicate() {
            return this.existingPhilamBilling.includes(this.philam_id);
        },

        clearFields() {
            this.monthly_premium = '';
            this.remarks = '';
        },
    },
};
